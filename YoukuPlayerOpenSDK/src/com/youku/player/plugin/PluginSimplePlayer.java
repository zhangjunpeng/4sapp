...
public class PluginSimplePlayer extends PluginOverlay implements DetailMessage {
	...
	private void initPlayLayout() {
		...
		title_cur_quality = (TextView) findViewById(R.id.cur_vidq);
		...
		vq0 = (TextView) pop.findViewById(R.id.vq0);
		vq1 = (TextView) pop.findViewById(R.id.vq1);
		vq2 = (TextView) pop.findViewById(R.id.vq2);
		...
		title_cur_quality.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				popVideoQuality.setWidth(v.getWidth());
				popVideoQuality.showAsDropDown(v);
			}
		});
		initSeekLoading();
		if (null != mMediaPlayerDelegate
	...
	public void onRealVideoStart() {
		...
		if (quality == (VideoQuality.STANDARD.ordinal())) {
			title_cur_quality.setText("标清");
		}
		if (quality == (VideoQuality.HIGHT.ordinal())) {
			title_cur_quality.setText("高清");
		}
		if (quality == (VideoQuality.SUPER.ordinal())) {
			title_cur_quality.setText("超清");
		}
	}
