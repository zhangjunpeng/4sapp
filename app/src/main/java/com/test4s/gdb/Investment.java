...
public class Investment {
    ...
    private transient InvestmentDao myDao;
    ...
    public Investment(Long id, String name, String introuduction, String location, String scale, String webSite, String telePhone, String address) {
        this.id = id;
        this.name = name;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getInvestmentDao() : null;
    }
    ...
    public List<GameInfo> getCases() {
        if (cases == null) {
            ...
            List<GameInfo> casesNew = targetDao._queryInvestment_Cases(id);
            synchronized (this) {
                if(cases == null) {
                    cases = casesNew;
                }
    ...
    public List<GameInfo> getGameInfoList() {
        if (gameInfoList == null) {
            ...
            GameInfoDao targetDao = daoSession.getGameInfoDao();
            List<GameInfo> gameInfoListNew = targetDao._queryInvestment_GameInfoList(id);
            synchronized (this) {
                if(gameInfoList == null) {
